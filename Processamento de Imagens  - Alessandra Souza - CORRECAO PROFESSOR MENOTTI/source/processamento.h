...
unsigned char **filtro_mediana(unsigned char **imagem, int tamanho, int largura, int mascara);
int calcula_lbp(int *vetor_imagem, int pixel);
unsigned char **filtro_lbp(unsigned char **imagem, int tamanho, int largura);
