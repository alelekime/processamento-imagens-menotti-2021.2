...
int main(int argc, char const *argv[])
{
    ...
    if (linhaComando->mascara)
        linhaComando->valor_mascara = 3;

    /* APLICA O FILTRO MEDIANA */
    // Menotti - retorno
    infoImagem->imagem = filtro_mediana(infoImagem->imagem, infoImagem->linhas, infoImagem->colunas, linhaComando->valor_mascara);
