...
int main(int argc, char const *argv[])
{
    ...
    if (linhaComando->limiar)
        linhaComando->valor_limiar = 0.5;
    
    /* APLICA O FILTRO LIMIAR */
    filtro_limiar(infoImagem->imagem, infoImagem->linhas, infoImagem->colunas, infoImagem->max_imagem, linhaComando->valor_limiar);
